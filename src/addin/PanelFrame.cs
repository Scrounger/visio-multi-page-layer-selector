...
namespace Visio_Multi_Page_Layer_Selector
{
    ...
    {
        private const string AddonWindowMergeId = "29672879-4afe-429d-8d80-acff0ec91d34";
            ...
            try
            {
                ...
                if (_form != null)
                {
                    _visioWindow = visioParentWindow.Windows.Add(
                        ...
                        0,
                        0,
                        Properties.Settings.Default.panel_width,
                        Properties.Settings.Default.panel_height,
                        AddonWindowMergeId,
                        string.Empty,
                        0);

                    _visioWindow.BeforeWindowClosed += OnBeforeWindowClosed;
                    _visioWindow.WindowChanged += OnWindowChanged;
        ...
        {
            PanelFrameClosed?.Invoke(_visioWindow.ParentWindow);
        ...
        private void OnWindowChanged(Window Window)
        {
            ...
            var lpRect = new RECT();
            GetWindowRect(parentWindowHandle, ref lpRect);
            var panelWidth = lpRect.right - lpRect.left;
            var panelHeight = lpRect.bottom - lpRect.top;

            Properties.Settings.Default.panel_width = panelWidth;
            Properties.Settings.Default.panel_height = panelHeight;
